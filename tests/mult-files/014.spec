...
void (014-a.c:5#5)^f(void) {
  (014-a.c:7#8)^ptr x;
  (014-a.c:8#2)^x =(ptr) focus48 &(cstr!0!014-a.c.hello);
}
...
(014-a.c:8#2)^cstr!0!014-a.c.hello =(int8) 104;
(014-a.c:8#2)^cstr!0!014-a.c.hello + 8 =(int8) 101;
(014-a.c:8#2)^cstr!0!014-a.c.hello + 16 =(int8) 108;
(014-a.c:8#2)^cstr!0!014-a.c.hello + 24 =(int8) 108;
(014-a.c:8#2)^cstr!0!014-a.c.hello + 32 =(int8) 111;
(014-a.c:8#2)^cstr!0!014-a.c.hello + 40 =(int8) 0;
