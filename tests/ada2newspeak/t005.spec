...
t005.adb
void t005(ptr, ptr) {
  (t005.adb:4#94)^[1-_int32]32 =(int32) belongs[-2147483648,2147483647] (0 - (2 * [1-_int32]32_ptr));
  (t005.adb:5#109)^[1-_int32]32 =(int32) -2;
  (t005.adb:7#128)^[1-_int32]32 =(int32) -7;
  (t005.adb:9#151)^[1-_int32]32 =(int32) belongs[-2147483648,2147483647] ((0 + (5 % 2)) - (-3 * (5 % 4)));
