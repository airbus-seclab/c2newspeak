...
void t432(void) {
  ...
  (t432.adb:11#9)^{
    int32 tmp_cir!1;
    (t432.adb:11#9)^tmp_cir!1: int32 <- t432a.mular(left_int32[10]: int32[10], res_int32: int32);
    (t432.adb:11#9)^res =(int32) tmp_cir!1_int32;
  }
  (t432.adb:12#8)^{
    int32 tmp_cir!0;
    (t432.adb:12#8)^tmp_cir!0: int32 <- t432a.mular(left_int32[10]: int32[10], 3: int32);
