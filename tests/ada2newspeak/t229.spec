...
void t229(void) {
  ...
  (t229.adb:17#367)^choose {
   -->
    (t229.adb:17#367)^guard((1-_int32 ==_int32 3));
    (t229.adb:13#231)^0- =(int32) 3;
    (t229.adb:13#231)^0- =(int32) 2;
   -->
    (t229.adb:17#367)^choose {
     -->
      (t229.adb:17#367)^guard((1-_int32 ==_int32 4));
      (t229.adb:14#265)^0- =(int32) 4;
      (t229.adb:14#265)^0- =(int32) 5;
     -->
      (t229.adb:17#367)^choose {
       -->
        (t229.adb:17#367)^guard((1-_int32 ==_int32 5));
        (t229.adb:15#299)^0- =(int32) 5;
        (t229.adb:15#299)^0- =(int32) 8;
       -->
        (t229.adb:17#367)^choose {
         -->
          (t229.adb:17#367)^guard((1-_int32 ==_int32 6));
