  ...
  (021.c:29#1112)^do {
    (021.c:33#1161)^do {
      (021.c:32#1146)^choose {
       -->
        (021.c:32#1146)^guard(! (x_int32 ==_int32 1));
        ...
        (021.c:39#1235)^do {
          (021.c:35#1190)^do {
            (021.c:34#1173)^choose {
             -->
              (021.c:34#1173)^guard(! (y_int32 ==_int32 2));
              (021.c:34#1173)^guard(! (y_int32 ==_int32 3));
          ...
          (021.c:36#1204)^y =(int32) 2;
          (021.c:37#1217)^goto lbl2;
        } with lbl4: {
        }
        (021.c:40#1249)^y =(int32) 3;
        (021.c:41#1262)^goto lbl2;
      } with lbl3: {
      }
      (021.c:44#1296)^y =(int32) 4;
    } with lbl2: {
    }
  } with lbl0: {
  }
