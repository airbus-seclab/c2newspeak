  ...
  (021.c:29#1112)^do {
    (021.c:33#1161)^do {
      (021.c:32#1146)^choose {
       -->
        (021.c:32#1146)^guard(! (1-_int32 ==_int32 1));
        ...
        (021.c:39#1235)^do {
          (021.c:35#1190)^do {
            (021.c:34#1173)^choose {
             -->
              (021.c:34#1173)^guard(! (0-_int32 ==_int32 2) & ! (0-_int32 ==_int32 3));
              (021.c:34#1173)^goto lbl3;
             -->
              (021.c:34#1173)^guard((0-_int32 ==_int32 2));
              (021.c:34#1173)^goto lbl5;
             -->
              (021.c:34#1173)^guard((0-_int32 ==_int32 3));
