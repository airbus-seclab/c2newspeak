...
void main(void) {
  ...
  (592.c:27#6)^{
    ...
    (592.c:28#1)^do {
      (592.c:30#2)^do {
        (592.c:29#2)^choose {
         -->
          ...
          (592.c:30#2)^goto lbl4;
         -->
          (592.c:29#2)^guard(! (0-_int32 ==_int32 1));
          (592.c:29#2)^goto lbl2;
        }
      } with lbl4: {
      }
      ...
      (592.c:31#4)^choose {
       -->
        (592.c:31#4)^guard(1-_uint32);
        (592.c:31#4)^goto lbl2;
       -->
        (592.c:31#4)^guard(! 1-_uint32);
      }
    } with lbl2: {
        ...
        (592.c:28#1)^do {
          (592.c:30#2)^do {
            (592.c:29#2)^choose {
             -->
              (592.c:29#2)^guard((0-_int32 ==_int32 1));
              (592.c:30#2)^goto lbl7;
             -->
              (592.c:29#2)^guard(! (0-_int32 ==_int32 1));
              (592.c:29#2)^goto lbl5;
            }
          } with lbl7: {
          }
          (592.c:31#4)^1- =(uint32) 1;
