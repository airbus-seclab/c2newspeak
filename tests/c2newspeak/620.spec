...
void main(void) {
  ...
  (620.c:27#6)^{
    ...
    (620.c:28#2)^{
      ...
      (620.c:28#2)^uint32 switch.620.c:28#2.0;
      (620.c:28#2)^do {
        ...
        (620.c:28#2)^choose {
         -->
          ...
          (620.c:28#2)^{
            ...
            (620.c:28#2)^choose {
             -->
              (620.c:28#2)^guard(! 4-_uint32);
              (620.c:28#2)^0- =(uint32) coerce[0,4294967295] 3-_int32;
             -->
              (620.c:28#2)^guard(4-_uint32);
              (620.c:28#2)^0- =(uint32) 0;
            }
            (620.c:28#2)^1- =(uint32) 0-_uint32;
          }
         -->
          (620.c:28#2)^guard(3-_uint32);
          (620.c:28#2)^0- =(uint32) 0;
        ...
        (620.c:32#2)^3- =(uint32) 3-_uint32;
        (620.c:32#2)^choose {
         -->
          (620.c:32#2)^guard(3-_uint32);
          (620.c:32#2)^goto lbl3;
         -->
          (620.c:32#2)^guard(! 3-_uint32);
        }
        (620.c:28#2)^3- =(uint32) 3-_uint32;
