Warning: 'short' is not normalized: use 'short int' instead in 033.c line 32
Warning: 'short' is not normalized: use 'short int' instead in 033.c line 33
Newspeak output
---------------
033.c
main() {
  ...
  (033.c:31#1152)^uint8;
  (033.c:32#1163)^int16;
  (033.c:33#1183)^uint16;
  (033.c:34#1192)^int32;
  (033.c:35#1210)^uint32;
  (033.c:36#1221)^ptr;
