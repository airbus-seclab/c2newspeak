Warning: 'short' is not normalized: use 'short int' instead in 240.c line 29
Warning: 'short' is not normalized: use 'short int' instead in 240.c line 30
...
main() {
  ...
  (240.c:28#1092)^uint8;
  (240.c:29#1103)^int16;
  (240.c:30#1123)^uint16;
  (240.c:31#1132)^int32;
  (240.c:32#1150)^uint32;
  (240.c:33#1160)^int32;
  (240.c:34#1179)^uint32;
  (240.c:35#1189)^ptr;
  (240.c:36#1200)^float32;
  (240.c:37#1212)^float64;
  (240.c:39#1222)^int32;
  ...
  (240.c:97#2069)^0- =(int32) ((ptr) 7-_int32 > 3-_ptr);
  ...
  (240.c:109#2213)^0- =(int32) ((ptr) 6-_uint32 > 3-_ptr);
  ...
  (240.c:121#2357)^0- =(int32) ((ptr) 5-_int32 > 3-_ptr);
  ...
  (240.c:133#2501)^0- =(int32) ((ptr) 4-_uint32 > 3-_ptr);
  (240.c:134#2514)^0- =(int32) ((float32 <= uint32) 4-_uint32 > 2-_float32);
  (240.c:135#2527)^0- =(int32) ((float64 <= uint32) 4-_uint32 > 1-_float64);
  (240.c:141#2753)^0- =(int32) (3-_ptr > (ptr) 7-_int32);
  (240.c:142#2766)^0- =(int32) (3-_ptr > (ptr) 6-_uint32);
  (240.c:143#2779)^0- =(int32) (3-_ptr > (ptr) 5-_int32);
  (240.c:144#2792)^0- =(int32) (3-_ptr > (ptr) 4-_uint32);
  (240.c:145#2805)^0- =(int32) (3-_ptr > 3-_ptr);
